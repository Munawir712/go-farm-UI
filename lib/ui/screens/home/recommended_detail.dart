...
class RecommendDetail extends StatelessWidget {
  final recommendModel;
  RecommendDetail({@required this.recommendModel});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body:  RecommendDetailBody(
...
class RecommendDetailBody extends StatefulWidget {
  final recommendModel;
  RecommendDetailBody({@required this.recommendModel});
  @override
  _RecommendDetailBodyState createState() => _RecommendDetailBodyState();
}

class _RecommendDetailBodyState extends State<RecommendDetailBody> {
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage(widget.recommendModel['path']),
                fit: BoxFit.cover,
              )
            ),
          ),
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(widget.recommendModel['name'], style: TextStyle(fontSize: 20, ),),
                SizedBox(height: 5,),
                Text(widget.recommendModel['name'], style: TextStyle(fontSize: 11, color: Colors.grey),),
                SizedBox(height: 20,),
                Row(
                  children: [
